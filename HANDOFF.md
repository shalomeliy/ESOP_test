...
עדכון אחרון: **2026-08-14** (v1.1.0 **שוחררה במלואה** - התוכן הושלם, כל
עשרת ה-commits נדחפו ל-`origin/main`, התג `v1.1.0` נדחף, וה-DB החי עלה
ל-head. אין פריט פתוח שנותר מהגרסה. ראו הבלוק הבא.)
