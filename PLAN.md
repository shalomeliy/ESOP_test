...
**Status: IN PROGRESS — steps 1-9 of §8 complete (see "Implementation notes" after each step below, and `HANDOFF.md` for the session-close context). Next: step 10 (history + reconciliation-report endpoints). Read this file in full before continuing, not just `HANDOFF.md`.**
