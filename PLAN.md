...
**Status: IN PROGRESS — steps 1-10 of §8 complete (see "Implementation notes" after each step below, and `HANDOFF.md` for the session-close context). Next: step 11 (UI: history table + modals in the admin portal). Read this file in full before continuing, not just `HANDOFF.md`.**
